...
// Database user
define('DC_DBUSER','myjuanbd');

// Database password
define('DC_DBPASSWORD','juaN1992');

// Database name
define('DC_DBNAME','dotclear436g');
...
define('DC_MASTER_KEY','63fa43e2a076f8d24363ebd3e9f3841f');

// Admin URL. You need to set it for some features.
define('DC_ADMIN_URL','http://www.juanbravo.es.mialias.net/dotclear/admin/');

// Admin mail from address. For password recovery and such.
define('DC_ADMIN_MAILFROM','juanbetis92@gmail.com');
